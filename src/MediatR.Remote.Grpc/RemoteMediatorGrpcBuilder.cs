...
public class RemoteMediatorGrpcBuilder
{
    ...
    public RemoteMediatorGrpcBuilder(IServiceCollection services)
    {
        Services = services;
    }
    ...
    public RemoteMediatorGrpcBuilder OverrideJsonSerializerOptions(Action<JsonSerializerOptions> options)
    {
    ...
    /// <returns></returns>
    public RemoteMediatorGrpcBuilder Add<TRequestStrategy, TNotificationStrategy, TStreamStrategy>(string name,
        ServiceLifetime serviceLifetime = ServiceLifetime.Scoped)
        where TRequestStrategy : IRemoteStrategy
    {
        var strategyItem = new StrategyTypes(
            typeof(TRequestStrategy),
            typeof(TNotificationStrategy),
